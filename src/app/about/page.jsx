...
const AboutUs = () => {
    ...
    const [isDisabled, setIsDisabled] = useState({ fwd: false, bwd: false });
        ...
        <main className={open_sans.className}>
            <header className="relative">
                <div className="lg:h-[90vh] h-[87vh] w-full hover:shadow-xl duration-300 ease-in-out top-0">
                    <video id="background-video" autoPlay muted style={{}} className='lg:block hidden ticky top-0 -z-10 h-screen w-screen object-cover' loop>
                        <source src="/videos/desktop/two.mp4" type="video/mp4" />
                    </video>
                    <video id="background-video" autoPlay muted style={{}} className='block lg:hidden fixed top-0 -z-10 h-screen w-screen object-right object-cover' loop>
            ...
            <section className="bg-white">
                ...
                <div className="container mx-auto lg:px-0 px-3">
                    ...
                    <div className="relative group w-full">
                        <div className="flex flex-row overflow-hidden lg:snap-x snap-y lg:space-x-4 lg:my-8">
                            <div className="flex-shrink-0 lg:mx-8 w-full" ref={strength}>
                                <AboutCom
                                    ...
                                    txtColor={"text-white"} orientation={"lg:flex-row flex-col-reverse"}
                                    title={"STRENGTH"} />
                            </div>
                            <div className="flex-shrink-0 lg:mx-8 w-full" ref={athletic}>
                                <AboutCom
                                    ...
                                    txtColor={"text-white"} orientation={"lg:flex-row flex-col"}
                                    title={"ATHLETIC"} />
                            </div>
                            <div className="flex-shrink-0 lg:mx-8 w-full" ref={zumba}>
                                <AboutCom
                                    ...
                                    txtColor={"text-neutral-800"} orientation={"lg:flex-row flex-col-reverse"}
                                    title={"ZUMBA"} />
                            </div>
                            <div className="flex-shrink-0 lg:mx-8 w-full" ref={kick_box}>
                                <AboutCom
                        ...
                        <div className="w-full absolute top-0 h-full overflow-x-hidden">
                            <div className={`flex ${isDisabled.bwd ? "flex-row-reverse" : "flex-row"} justify-between h-full`}>
                                <button className={`w-fit active:scale-95 duration-300 ease-in-out cursor-pointer lg:-translate-x-16 group-hover:translate-x-0 ${isDisabled.bwd ? "hidden" : "block"}`}
                                    onClick={() => setDir("left")}>
                                ...
                                <button className={`w-fit active:scale-95 duration-300 ease-in-out cursor-pointer lg:translate-x-16 group-hover:translate-x-0 ${isDisabled.fwd ? "hidden" : "block"}`}
