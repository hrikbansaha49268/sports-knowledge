...
export default function Home() {
  return (
    <main className={open_sans.className}>
      <video id="background-video" autoPlay muted style={{}} className='lg:block laptop:block hidden fixed top-0 -z-10 h-screen w-screen object-cover bg-black' loop>
        <source src="/videos/desktop/one.mp4" type="video/mp4" />
      </video>
      <video id="background-video" autoPlay muted style={{}} className='block laptop:hidden lg:hidden fixed top-0 -z-10 h-screen w-screen object-cover bg-black' loop>
        <source src="/videos/mobile/one.mp4" type="video/mp4" />
      </video>
      <div className="h-screen container mx-auto flex flex-col justify-center lg:px-0 laptop:px-4">
