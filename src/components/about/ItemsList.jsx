        ...
        <div className="flex flex-row overflow-x-hidden snap-x lg:space-x-4 laptop:space-x-3 laptop:my-8 lg:my-8 box-box">
            <div className="flex-shrink-0 lg:mx-8 laptop:mx-8 w-full" ref={referenceList[0]}>
                <AboutItem
                    ...
                    txtColor={"text-white"} orientation={"lg:flex-row md:flex-row laptop:flex-row-reverse flex-col"}
                    title={"STRENGTH"} />
            </div>
            <div className="flex-shrink-0 lg:mx-8 laptop:mx-8 w-full" ref={referenceList[1]}>
                <AboutItem
                    ...
                    txtColor={"text-white"} orientation={"lg:flex-row-reverse md:flex-row-reverse laptop:flex-row-reverse flex-col"}
                    title={"ATHLETIC"} />
            </div>
            <div className="flex-shrink-0 lg:mx-8 laptop:mx-8 w-full" ref={referenceList[2]}>
                <AboutItem
                    ...
                    txtColor={"text-neutral-800"} orientation={"lg:flex-row md:flex-row laptop:flex-row-reverse flex-col"}
                    title={"ZUMBA"} />
            </div>
            <div className="flex-shrink-0 lg:mx-8 laptop:mx-8 w-full" ref={referenceList[3]}>
                <AboutItem
                    ...
                    txtColor={"text-white"} orientation={"lg:flex-ro-reversew md:flex-row-reverse laptop:flex-row-reverse flex-col"}
                    title={"KICK BOXING"} />
            </div>
        </div>
    );
